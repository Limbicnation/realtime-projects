...
public:
	...
	FDialogueLine()
	{
		...
		Shot = nullptr;
		Sequence = nullptr;
		SequenceSettings = FMovieSceneSequencePlaybackSettings();
	}
	...
	*/
	...
	/**
	Camera shot to play for this dialogue line
	*/
	UPROPERTY(EditAnywhere, Instanced, Category = "Details")
	class UNarrativeDialogueShot* Shot;

	/**
	Optional sequence to play for this dialogue line 
	*/
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Details")
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Details")
	struct FMovieSceneSequencePlaybackSettings SequenceSettings;
 ...
 public:
	...
	*/
	 ...
	 */
	 ...
	 For multi-NPC dialogues, narrative will try find a skeletal mesh on the NPCActor with the speakers ID added as a tag and use that.

	 If you need more complex behavior than this, you may wish to override PlayDialogueMontage and do whatever you need 
	 */
	 UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Details")
	 class UAnimMontage* DialogueMontage;

	 /**The dialogue shot for this dialogue node*/
	 UPROPERTY(EditAnywhere, Instanced, Category = "Details")
	 class UNarrativeDialogueShot* Shot;
